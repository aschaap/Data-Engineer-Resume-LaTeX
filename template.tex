...
\projects{
	\begin{description}
    \item[\href{https://facilities.mcmaster.ca/sustainability/from-trash-to-treasure/}{From Trash to Treasure}] Diverting waste by collecting, sanitizing, and refurbishing e-waste for children in need within the community, students, and acquaintances.
    \begin{itemize}
      \item Climate Change and Health---Innovation Award
    \end{itemize}
    \item[Homelab] OPNsense router, network boot server, and file server (ZFS) running NextCloud and BorgBackup.
	\item[\href{https://devpost.com/software/dana}{\textbf{Dana}}] Website in Ruby and JS to connect restaurants for donating excess food and people in need.
  \begin{itemize}
...
%  {}
%  {Continuing the ``From Trash to Treasure'' project:
%    \begin{itemize}
...
%      \end{itemize}
%      \item Established and maintained relationships with student orgs.
