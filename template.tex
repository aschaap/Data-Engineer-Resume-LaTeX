...
\programming{{OCaml $\textbullet$ Linux $\textbullet$ \LaTeX / 5.8}, {Java $\textbullet$ Lua $\textbullet$ Git / 5.5}, {Haskell $\textbullet$ C \& C++ $\textbullet$ JS / 5}}
...
\projects{
    ...
    \end{itemize}
    \item[Homelab] Maintaining personal OPNsense router, network boot server, and file server (using the Zettabyte File System).
