...
\programming{{Haskell $\textbullet$ C++ $\textbullet$ JS / 2.5}, {Java $\textbullet$ Lua $\textbullet$ Git / 3.5}, {OCaml $\textbullet$ Linux $\textbullet$ \LaTeX / 5}}

% Projects text
\projects{
	\begin{description}
    \item[Self-hosting] OPNsense router, netboot server, and Debian home server on ZFS for backups via BorgBackup, synchronization via Syncthing and task management via KanBoard.
